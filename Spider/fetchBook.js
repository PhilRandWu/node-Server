 ...
 * @Date: 2022-04-08 21:52:46
 * @LastEditTime: 2022-04-09 09:03:19
...
async function getBookLinks() {
  ...
  console.log('achorElements',achorElements)
...
async function getBookDetail(detailUrl) {
  ...
  const openBook = publishSpan[0].nextSibling.nodeValue.trim();
  return {
    name,
    imgSrc,
    openBook,
